...
-	[`0.5.2`, `latest`](https://github.com/sysflow-telemetry/sf-collector/blob/0.5.2/Dockerfile), [`edge`](https://github.com/sysflow-telemetry/sf-collector/blob/master/Dockerfile), [`dev`](https://github.com/sysflow-telemetry/sf-collector/blob/dev/Dockerfile)
...
-	**Binary packages**:
	[deb](https://github.com/sysflow-telemetry/sf-collector/releases/tag/0.5.2/sfcollector-0.5.2-x86_64.deb) | [rpm](https://github.com/sysflow-telemetry/sf-collector/releases/tag/0.5.2/sfcollector-0.5.2-x86_64.rpm) | [tgz](https://github.com/sysflow-telemetry/sf-collector/releases/tag/0.5.2/sfcollector-0.5.2-x86_64.tar.gz)
