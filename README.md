...
-	[`0.1-rc2`](https://github.com/sysflow-telemetry/sf-collector/blob/0.1-rc2/Dockerfile), [`latest`](https://github.com/sysflow-telemetry/sf-collector/blob/master/Dockerfile)
