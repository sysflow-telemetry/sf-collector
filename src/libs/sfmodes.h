...
static const std::unordered_set<uint32_t> SF_CONSUMER_SC_SET{
    ...
    PPM_SC_LINKAT,     PPM_SC_MKDIR,       PPM_SC_MKDIRAT,   PPM_SC_OPEN,
    PPM_SC_OPENAT,     PPM_SC_OPENAT2,     PPM_SC_RECVFROM,  PPM_SC_RECVMMSG,
    PPM_SC_RECVMSG,    PPM_SC_RENAME,      PPM_SC_RENAMEAT,  PPM_SC_RENAMEAT2,
    PPM_SC_RMDIR,      PPM_SC_SENDMMSG,    PPM_SC_SENDMSG,   PPM_SC_SENDTO,
    PPM_SC_SETRESUID,  PPM_SC_SETRESUID32, PPM_SC_SETUID,    PPM_SC_SETUID32,
    PPM_SC_SOCKETPAIR, PPM_SC_SYMLINK,     PPM_SC_SYMLINKAT, PPM_SC_UNLINK,
...
static const std::unordered_set<uint32_t> SF_NO_FILES_SC_SET{
    ...
    PPM_SC_OPENAT2,     PPM_SC_RECVFROM, PPM_SC_RECVMMSG, PPM_SC_RECVMSG,
    PPM_SC_SENDMMSG,    PPM_SC_SENDMSG,  PPM_SC_SENDTO,   PPM_SC_SETRESUID,
    PPM_SC_SETRESUID32, PPM_SC_SETUID,   PPM_SC_SETUID32, PPM_SC_SOCKETPAIR,
    PPM_SC_VFORK,
};
#endif