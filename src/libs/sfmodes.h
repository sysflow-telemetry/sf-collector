...
static const std::unordered_set<uint32_t> SF_CONSUMER_SC_SET{
    ...
    PPM_SC_RENAMEAT,  PPM_SC_RENAMEAT2, PPM_SC_RMDIR,      PPM_SC_SENDMMSG,
    PPM_SC_SENDMSG,   PPM_SC_SETNS,     PPM_SC_SETRESUID,  PPM_SC_SETRESUID32,
    PPM_SC_SETUID,    PPM_SC_SETUID32,  PPM_SC_SOCKETPAIR, PPM_SC_SYMLINK,
    PPM_SC_SYMLINKAT, PPM_SC_UNLINK,    PPM_SC_UNLINKAT,   PPM_SC_VFORK,
};
#endif